...
//
//   - The hash is needed because UNIX domain socket paths are limited to 108 characters. By using a b64 encoded
//     SHA1 hash we end up with 27 chars for the name, 5 chars for the extension, and up to 76 chars are left for the
//     user-configurable socket dir.
